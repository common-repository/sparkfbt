...
class PluginsPageModule implements ModuleInterface
{
    ...
    public function addPluginPageActionLinks($links)
    {
        ...
        $settingsLink = '<a href="' . $settingsUrl . '">' . __('Settings', 'sparkfbt') . '</a>';
        $upgradeProLink = '<a target="_blank" href="' . $this->pluginMeta->websiteUrl . '">' . __('Upgrade PRO', 'sparkfbt') . '</a>';
    ...
    public function addPluginPageRowLinks($links, $file)
    {
        ...
        $supportLink = '<a target="_blank" href="https://www.sparkplugins.com/support/">' . __('Support', 'sparkfbt') . '</a>';
        $prependLinks = array();
