...
namespace Sparkfbt\SparkPlugins\SparkWoo\ProductRecommendations\Models;

use Sparkfbt\SparkPlugins\SparkWoo\Common\Collections\CollectionInterface;
use Sparkfbt\SparkPlugins\SparkWoo\Common\Models\AbstractPostModel;
...
class ProductRecommendationPostModel extends AbstractPostModel implements PostModelInterface
{
    ...
    {
        $labels = array('name' => __('Product recommendations', 'sparkfbt'), 'singular_name' => __('Product recommendation', 'sparkfbt'), 'menu_name' => __('Product recommendations', 'sparkfbt'), 'all_items' => __('All product recommendations', 'sparkfbt'), 'view_item' => __('View product recommendation', 'sparkfbt'), 'add_new_item' => __('Add product recommendation', 'sparkfbt'), 'add_new' => __('Add product recommendation', 'sparkfbt'), 'edit_item' => __('Edit product recommendation', 'sparkfbt'), 'update_item' => __('Update product recommendation', 'sparkfbt'), 'search_items' => __('Search product recommendations', 'sparkfbt'), 'not_found' => __('Not found', 'sparkfbt'), 'not_found_in_trash' => __('Not found in bin', 'sparkfbt'));
        $args = array('label' => __('Product recommendations', 'sparkfbt'), 'description' => __('Product recommendations', 'sparkfbt'), 'rewrite' => array('slug' => 'product_recommendations'), 'labels' => $labels, 'supports' => array('title', 'custom-fields'), 'hierarchical' => \false, 'public' => \false, 'show_ui' => SPARK_DEV_MODE, 'show_in_menu' => \true, 'show_in_nav_menus' => \false, 'show_in_admin_bar' => \false, 'menu_position' => 5, 'can_export' => \false, 'has_archive' => \false, 'exclude_from_search' => \false, 'publicly_queryable' => \false, 'query_var' => \false, 'capability_type' => 'post', 'show_in_rest' => \false);
        return $args;
    }
