...
namespace Sparkfbt\SparkPlugins\SparkWoo\ProductRecommendationsFree\Analytics;

use Sparkfbt\SparkPlugins\SparkWoo\Common\Database\Database;
use Sparkfbt\SparkPlugins\SparkWoo\Common\Database\OrderItem;
use Sparkfbt\SparkPlugins\SparkWoo\Common\Loader;
use Sparkfbt\SparkPlugins\SparkWoo\Common\Modules\ModuleInterface;
use Sparkfbt\SparkPlugins\SparkWoo\Common\Notifications\DismissNotificationTrait;
use Sparkfbt\SparkPlugins\SparkWoo\Common\Notifications\NotificationModule;
use Sparkfbt\SparkPlugins\SparkWoo\Common\Options\StringOption;
use Sparkfbt\SparkPlugins\SparkWoo\Common\Plugins\PluginMeta;
use Sparkfbt\SparkPlugins\SparkWoo\ProductRecommendations\Analytics\AnalyticsEvent;
use Sparkfbt\SparkPlugins\SparkWoo\ProductRecommendations\Analytics\AnalyticsEventRepository;
