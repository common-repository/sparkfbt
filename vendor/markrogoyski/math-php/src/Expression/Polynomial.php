...
namespace Sparkfbt\MathPHP\Expression;

use Sparkfbt\MathPHP\Algebra;
use Sparkfbt\MathPHP\Exception;
use Sparkfbt\MathPHP\Functions\Arithmetic;
use Sparkfbt\MathPHP\Functions\Map;
use Sparkfbt\MathPHP\LinearAlgebra\MatrixFactory;
use Sparkfbt\MathPHP\LinearAlgebra\NumericSquareMatrix;
use Sparkfbt\MathPHP\LinearAlgebra\Vector;
use Sparkfbt\MathPHP\Number\Complex;
use Sparkfbt\MathPHP\Number\ObjectArithmetic;
/**
...
class Polynomial implements ObjectArithmetic
{
    ...
    {
        return new Polynomial(Map\Single::multiply($this->coefficients, -1));
    }
    /**
    ...
    public function companionMatrix() : NumericSquareMatrix
    {
         ...
         *  | -cᶰ₋₁ |
         */
        $columnMatrix = Matrixfactory::createFromVectors([$reversedCoefficients])->scalarDivide(-1 * $coefficients[0])->rowExclude($this->getDegree());
         ...
         */
        $companion = $identityMatrix->augmentAbove($zero_row)->augment($columnMatrix);
        return $companion;
    }
}
