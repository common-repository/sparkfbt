...
namespace Sparkfbt\MathPHP\Functions;

use Sparkfbt\MathPHP\Exception;
class Support
{
    private const ε = 9.999999999999999E-12;
    /**
    ...
    public static function checkLimits(array $limits, array $params) : bool
    {
        ...
        if (!empty($undefined_limits)) {
            throw new Exception\BadParameterException('Parameter without bounds limit defined: ' . \print_r($undefined_limits, \true));
        }
