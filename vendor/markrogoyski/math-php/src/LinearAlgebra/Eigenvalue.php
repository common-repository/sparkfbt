...
use Sparkfbt\MathPHP\Expression\Polynomial;
...
class Eigenvalue
{
    ...
    private const METHODS = [self::CLOSED_FORM_POLYNOMIAL_ROOT_METHOD, self::POWER_ITERATION, self::JACOBI_METHOD];
    /**
    ...
    public static function jacobiMethod(NumericMatrix $A) : array
    {
        ...
        $iterations = 0;
        // For infinitely oscillating edge cases between very small positive and negative numbers that don't converge
        while (!$D->isDiagonal()) {
