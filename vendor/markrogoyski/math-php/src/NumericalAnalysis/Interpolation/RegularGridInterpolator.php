...
namespace Sparkfbt\MathPHP\NumericalAnalysis\Interpolation;

use Sparkfbt\MathPHP\Exception;
use Sparkfbt\MathPHP\Search;
use Sparkfbt\MathPHP\Util\Iter;
/**
...
class RegularGridInterpolator
{
    ...
    public function __invoke(array $xi) : float
    {
        ...
        return $this->method === self::METHOD_LINEAR ? $this->evaluateLinear($indices, $normDistances) : $this->evaluateNearest($indices, $normDistances);
    }
    /**
    ...
    private function evaluateLinear(array $indices, array $normDistances)
    {
        ...
        $edges[] = 1;
        // pass last argument (repeat)
        $edges = $this->product(...$edges);
