...
namespace Sparkfbt\MathPHP\NumericalAnalysis\NumericalDifferentiation;
...
abstract class NumericalDifferentiation
{
     ...
     * @return mixed
     */
    public static abstract function differentiate(float $target, $source, ...$args);
    /**
    ...
    {
        $xComponents = \array_map(function (array $point) {
            return $point[self::X];
        }, $sorted);
