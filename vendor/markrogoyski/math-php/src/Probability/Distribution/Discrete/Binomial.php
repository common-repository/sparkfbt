...
use Sparkfbt\MathPHP\Arithmetic;
use Sparkfbt\MathPHP\Probability\Combinatorics;
...
class Binomial extends Discrete
{
     ...
     */
    public const PARAMETER_LIMITS = ['n' => '[0,∞)', 'p' => '[0,1]'];
    /**
     * Distribution support bounds limits
     * r ∈ [0,∞)
     * @var array{"r": string}
     */
    public const SUPPORT_LIMITS = ['r' => '[0,∞)'];
    ...
    public function pmf(int $r) : float
    {
        ...
        return $this->n < 150 ? $this->combinatorialMethod($r) : $this->multiplicationMethod($r, $this->n, $this->p);
    }
    /**
