...
namespace Sparkfbt\MathPHP\Probability\Distribution\Multivariate;
...
class Multinomial
{
    ...
    public function pmf(array $frequencies) : float
    {
        ...
        $x₁！⋯xk！ = \array_product(\array_map('Sparkfbt\\MathPHP\\Probability\\Combinatorics::factorial', $frequencies));
        $p₁ˣ¹⋯pkˣᵏ = \array_product(\array_map(function ($x, $p) {
            return $p ** $x;
        }, $frequencies, $this->probabilities));
