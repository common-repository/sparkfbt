...
class ToothGrowth
{
    ...
    private const DATA = [[4.2, 'VC', 0.5], [11.5, 'VC', 0.5], [7.3, 'VC', 0.5], [5.8, 'VC', 0.5], [6.4, 'VC', 0.5], [10.0, 'VC', 0.5], [11.2, 'VC', 0.5], [11.2, 'VC', 0.5], [5.2, 'VC', 0.5], [7.0, 'VC', 0.5], [16.5, 'VC', 1.0], [16.5, 'VC', 1.0], [15.2, 'VC', 1.0], [17.3, 'VC', 1.0], [22.5, 'VC', 1.0], [17.3, 'VC', 1.0], [13.6, 'VC', 1.0], [14.5, 'VC', 1.0], [18.8, 'VC', 1.0], [15.5, 'VC', 1.0], [23.6, 'VC', 2.0], [18.5, 'VC', 2.0], [33.9, 'VC', 2.0], [25.5, 'VC', 2.0], [26.4, 'VC', 2.0], [32.5, 'VC', 2.0], [26.7, 'VC', 2.0], [21.5, 'VC', 2.0], [23.3, 'VC', 2.0], [29.5, 'VC', 2.0], [15.2, 'OJ', 0.5], [21.5, 'OJ', 0.5], [17.6, 'OJ', 0.5], [9.699999999999999, 'OJ', 0.5], [14.5, 'OJ', 0.5], [10.0, 'OJ', 0.5], [8.199999999999999, 'OJ', 0.5], [9.4, 'OJ', 0.5], [16.5, 'OJ', 0.5], [9.699999999999999, 'OJ', 0.5], [19.7, 'OJ', 1.0], [23.3, 'OJ', 1.0], [23.6, 'OJ', 1.0], [26.4, 'OJ', 1.0], [20.0, 'OJ', 1.0], [25.2, 'OJ', 1.0], [25.8, 'OJ', 1.0], [21.2, 'OJ', 1.0], [14.5, 'OJ', 1.0], [27.3, 'OJ', 1.0], [25.5, 'OJ', 2.0], [26.4, 'OJ', 2.0], [22.4, 'OJ', 2.0], [24.5, 'OJ', 2.0], [24.8, 'OJ', 2.0], [30.9, 'OJ', 2.0], [26.4, 'OJ', 2.0], [27.3, 'OJ', 2.0], [29.4, 'OJ', 2.0], [23.0, 'OJ', 2.0]];
    /**
