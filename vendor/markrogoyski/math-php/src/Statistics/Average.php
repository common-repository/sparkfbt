...
class Average
{
    ...
    public static function weightedMean(array $numbers, array $weights) : float
    {
        ...
        $∑⟮xᵢwᵢ⟯ = \array_sum(\array_map(function ($xᵢ, $wᵢ) {
            return $xᵢ * $wᵢ;
        }, $numbers, $weights));
    ...
    public static function geometricMean(array $numbers) : float
    {
        ...
        $n = \count($numbers);
        $a₀a₁a₂⋯ = \array_reduce($numbers, function ($carry, $a) {
            return $carry * $a;
        }, 1);
    ...
    public static function harmonicMean(array $numbers) : float
    {
        ...
        $negativeValues = \array_filter($numbers, function ($x) {
            return $x < 0;
        });
