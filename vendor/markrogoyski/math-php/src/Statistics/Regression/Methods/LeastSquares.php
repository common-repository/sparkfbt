...
namespace Sparkfbt\MathPHP\Statistics\Regression\Methods;

use Sparkfbt\MathPHP\Exception\BadDataException;
use Sparkfbt\MathPHP\Exception\BadParameterException;
use Sparkfbt\MathPHP\Exception\IncorrectTypeException;
use Sparkfbt\MathPHP\LinearAlgebra\MatrixFactory;
use Sparkfbt\MathPHP\Statistics\RandomVariable;
use Sparkfbt\MathPHP\Functions\Map\Single;
use Sparkfbt\MathPHP\Functions\Map\Multi;
use Sparkfbt\MathPHP\Probability\Distribution\Continuous\F;
use Sparkfbt\MathPHP\Probability\Distribution\Continuous\StudentT;
...
trait LeastSquares
{
    ...
    public function cooksD() : array
    {
        ...
        return \array_map(function ($eᵢ, $hᵢ) use($mse, $p) {
    ...
    public function tProbability() : array
    {
        ...
        return ['m' => $studentT->cdf($t['m']), 'b' => $studentT->cdf($t['b'])];
    }
    /**
